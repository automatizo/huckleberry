module Huckleberry
  class Ingredient < ActiveRecord::Base
    ...
    has_one :protein, foreign_key: :nutrient_databank_number
    has_one :sterol, foreign_key: :nutrient_databank_number
    ...
    delegate :total_protein, to: :protein
    delegate :cholesterol, :phytosterol, to: :sterol
  end
end
